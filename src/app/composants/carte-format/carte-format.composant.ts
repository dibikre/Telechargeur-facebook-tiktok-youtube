...
@Component({
  ...
  template: `
    <div class="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl border border-outline-variant/60 dark:border-outline bg-surface-container-lowest dark:bg-inverse-surface hover:border-primary transition-all duration-200 group gap-4">
