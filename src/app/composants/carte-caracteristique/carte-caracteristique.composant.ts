...
@Component({
  ...
  template: `
    <div class="bg-surface-container-lowest dark:bg-inverse-surface rounded-2xl p-8 border border-surface-variant dark:border-outline/40 shadow-sm text-center flex flex-col items-center hover:-translate-y-1 transition-all duration-300">
